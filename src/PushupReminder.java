...
public class PushupReminder {
    ...
    private static Image loadIcon(Device device) throws Exception {
        InputStream in = PushupReminder.class.getClassLoader().getResourceAsStream("icon.png");
    ...
    private static void alert(Shell shell, TrayItem item, String title, String message) {
